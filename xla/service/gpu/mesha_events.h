#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_GPU_MESHA_EVENTS_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_GPU_MESHA_EVENTS_H_

#include "absl/container/flat_hash_map.h"
#include "xla/status_macros.h"
#include "xla/stream_executor/stream.h"
// This file provides APIs to sync Mesha's multi-stream behavior with
// XLA's own streams
namespace xla {
namespace gpu {
...
// PipeShardExecutable.
void ResetMeshaEvents();
};      // namespace gpu
};      // namespace xla
#endif  // TENSORFLOW_COMPILER_XLA_SERVICE_GPU_MESHA_EVENTS_H_
